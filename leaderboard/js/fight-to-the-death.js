...
import { applyUpgradeDiscountPercentage, calculateTotalTitanDeployPoints } from '/warrobots-calculator-beta/js/modifier-helper.js?v=1.12.9-beta';
...
const TYPES = ['T3Robot', 'T4Robot', 'T3Weapon', 'T4Weapon'];
